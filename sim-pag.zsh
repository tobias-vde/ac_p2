...
#"(Y-X) log2(X)"
for E in "4 4 2"   "8 16 4"   "16 64 6"   "32 256 8"   "64 1024 10"   "32 2048 11"; do
	V=$(echo $E | cut -f2 -d' ') # 4 16 256 1024 2048
	RESULTS_DIR="$DIR/results_pag_${V}"
